...
class _WeatherDashboardScreenState extends State<WeatherDashboardScreen> {
  ...
  final TextEditingController location = TextEditingController(text: 'Kegalle');
  ...
  Future<void> getWeather(String location) async {
    try {
      ...
      log(w.toString());
      log("Humidity: ${w?.humidity}");
      log("Pressure: ${w?.pressure}");
      log("Wind: ${w?.windSpeed}");
    } catch (e) {
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CurrentLocationCard(location: location.text),
...
class _WeatherWeekDetailsState extends State<WeatherWeekDetails> {
  ...
  Future<void> getWeeklyWeather() async {
    ...
    List<Weather> forecast =
        await wf.fiveDayForecastByCityName(widget.location);
